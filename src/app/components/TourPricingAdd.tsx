...
export const TourPricing = ({
  ...
  const message = selectedDate
    ? encodeURIComponent(`Hola, Vi un anuncio sobre el tour ${nombre_tour} y me interesaria viajar el ${formattedDate}.`)
    : encodeURIComponent(`Hola, Vi un anuncio sobre el tour ${nombre_tour}. ¿Podrían brindarme más información?`);
